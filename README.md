...
GridsearchCV, RandomForest, Logistic Regression, XGBoost
...
Developed a ML model to predict diabetes risk using PIMA Indians healthcare data. Includes preprocessing, feature analysis, model training, and evaluation using ROC-AUC.
